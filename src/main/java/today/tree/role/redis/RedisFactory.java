...
public interface RedisFactory {
    ...
    /**
     * @description: 管道调用hmget,且获取的Hash表fields一致
     * @date:2017年6月16日下午2:01:45
     * @param: 
     * @return:
     */
    List<Object> multiHmget(List<String> keys,String... fields);
    
    /**
     * @description: 管道调用hmget,获取Hash的fields不一致
     * @date:2017年6月16日下午2:02:11
     * @param: 
     * @return:
     */
    List<Object> multiHmget(Map<String,String[]> map);
    /**
     * @description: 序列化,按字节流设置hash表
     * @date:2017年6月20日上午11:48:38
     * @param: 
     * @return:
     */
    String hmset(byte[] key, Map<byte[], byte[]> hash);
    /**
     * @description: 反序列化,按字节流获取hash表
     * @date:2017年6月20日上午11:53:10
     * @param: 
     * @return:
     */
